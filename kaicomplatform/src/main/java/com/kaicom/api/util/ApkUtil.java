...
import kaicom.android.app.manager.MemorySpaceCheck;
...
public final class ApkUtil {
     ...
     *
     * @param activity
     * @param iconResId    快捷方式图标资源
     * @param appnameResId app名称资源
     */
    ...
    private static boolean isShortCutExist(String appName) {
        ...
        Cursor c = KaicomApplication.app.getContentResolver().query(uri, null, selection,
                selectionArgs, null);
        if (c == null) {
            return false;
        }
