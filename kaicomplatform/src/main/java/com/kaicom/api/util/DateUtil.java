...
public final class DateUtil {
     ...
     * 求两个日期相差分钟
     *
     * @param start 起始日期，格式yyyy-MM-dd HH:mm:ss
     * @param end 终止日期，格式yyyy-MM-dd HH:mm:ss
     * @return 两个日期相差分钟
     */
    public static long getIntervalMins(String start, String end) {
        long endTime = getDateByFormat(end, "yyyy-MM-dd HH:mm:ss").getTime();
        long startTime = getDateByFormat(start, "yyyy-MM-dd HH:mm:ss").getTime();
        long intervalTime = endTime - startTime;
        System.out.println(start+":"+startTime+","+end+":"+endTime+"。"+intervalTime);
     ...
     * @return  返回yyyyMMdd格式
     */
    public static String getYMDOtherDay(int diff) {
        Calendar mCalendar = Calendar.getInstance();
        mCalendar.add(Calendar.DATE, diff);
    ...
    /**
     * 获取年月日时分秒 (格式：yyyy-MM-dd HH:mm:ss)
     *
     * @return yyyy-MM-dd HH:mm:ss
     */
    public static String getYearMonthDayTime(){
        SimpleDateFormat sDateFormat = new SimpleDateFormat(DEFAULT_DATE_TIME_FORMAT);
