...
public class SoundManager {
    ...
    public synchronized static SoundManager getInstance() {
        if (soundManager == null) {
            soundManager = new SoundManager(KaicomApplication.app);
        }
        return soundManager;
    }
    ...
    public void initSoundPool() {
        try {
            ...
            spMap.put(SCAN_NORMAL, sp.load(context, R.raw.scan_normal, 1));
            ...
            spMap.put(PIC_UPLOAD_FAILURE,
                    sp.load(context, R.raw.pic_upload_failure, 1));
