package com.kaicom.api.view.edittext;
...
import com.kaicom.api.manager.LedFlashManager;
import com.kaicom.api.manager.sound.SoundManager;
import com.kaicom.api.manager.sound.SpeechSoundManager;
import com.kaicom.api.scan.KeyCodeConstant;
 ...
 * @author scj
 */
public class StdEditText extends EditText {
    ...
    public void alertError(String message) {
        ...
        vibtor.vibrate(300);
        LedFlashManager.getInstance().errorFlash();
        requestFocus();
